...
package cn.vansky.framework.core.orm.mybatis.plugin.monitor;

import cn.vansky.framework.core.orm.SqlEvent;
...
public class SqlMonitorManager implements Interceptor {
     ...
     * @return SQL in string
     * @throws java.sql.SQLException in case of any SQL operation exception
     */
