...
import cn.vansky.framework.common.util.JndiUtils;
import cn.vansky.framework.core.bean.config.PlaceholderResolver;
import cn.vansky.framework.core.bean.config.PropertyPlaceholderConfigurerTool;
