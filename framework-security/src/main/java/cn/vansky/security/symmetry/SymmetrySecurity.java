...
public abstract class SymmetrySecurity implements ISecurity {
     ...
     * The Cipher.
     * @return the Cipher
     * @throws javax.crypto.NoSuchPaddingException the NoSuchPaddingException
     * @throws java.security.NoSuchAlgorithmException the NoSuchAlgorithmException
     */
     ...
     * @return the Key
     * @throws java.security.NoSuchAlgorithmException the NoSuchAlgorithmException
     * @throws java.security.InvalidKeyException the InvalidKeyException
     * @throws java.security.spec.InvalidKeySpecException the InvalidKeySpecException
     * @throws java.io.UnsupportedEncodingException the UnsupportedEncodingException
     */
