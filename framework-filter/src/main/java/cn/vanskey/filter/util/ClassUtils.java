...
import cn.vanskey.filter.exception.UnknownClassException;
...
public class ClassUtils {
    ...
    public static Object newInstance(Class clazz) {
        ...
        try {
            ...
            throw new cn.vanskey.filter.exception.InstantiationException("Unable to instantiate class [" + clazz.getName() + "]", e);
        }
    }
    ...
    public static Object instantiate(Constructor ctor, Object... args) {
        try {
            ...
            throw new cn.vanskey.filter.exception.InstantiationException(msg, e);
        }
    }
